...
// ReportKind selects the report granularity for the zcode adapter.
type ReportKind int
...
// rows. Weekly buckets start Monday, like the unified report.
func SummarizeEntries(entries []core.LoadedEntry, kind ReportKind) []core.UsageSummary {
	...
	case KindMonthly:
		...
		return core.SummarizeSummariesByBucket(daily, core.BucketMonthly, core.Monday)
	case KindSession:
