...
// Lenient JSON field helpers ported from rust adapters/common/src/jsonl.rs so
// typed structs behave like the historical dynamic-Value navigation: an
// unexpectedly typed field never fails the whole record.
